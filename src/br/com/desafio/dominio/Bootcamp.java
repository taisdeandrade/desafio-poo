...
public class Bootcamp {
    ...
    private Set<Dev> devsInscritos = new HashSet<>();//hashSet pq a ordem não importa
    private Set<Conteudo> conteudos = new LinkedHashSet<>();//a ordem dos conteudos importa
